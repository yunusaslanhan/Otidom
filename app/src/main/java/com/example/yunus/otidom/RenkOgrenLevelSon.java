...
public class RenkOgrenLevelSon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_renk_ogren_level_son);
        ...
        btnCikis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(RenkOgrenLevelSon.this,OyunlarActivity.class);
