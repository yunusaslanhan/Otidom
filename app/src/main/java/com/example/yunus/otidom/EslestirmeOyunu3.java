...
public class EslestirmeOyunu3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eslestirme_oyunu3);
        rootLayout = (ViewGroup) findViewById(R.id.view_root3);
        img = (ImageView) rootLayout.findViewById(R.id.imageView3);

        final MediaPlayer elmayiesle = MediaPlayer.create(this, R.raw.seftaliyiesle);
        elma = MediaPlayer.create(this,R.raw.seftali);
        ...
        img.setOnTouchListener(new EslestirmeOyunu3.ChoiceTouchListener());
    }
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (layoutParams.x>15 && layoutParams.x<80 && layoutParams.y>180 && layoutParams.y<260){
                        ...
                        Intent intent2 = new Intent(EslestirmeOyunu3.this,EslestirmeOyunu4.class);
