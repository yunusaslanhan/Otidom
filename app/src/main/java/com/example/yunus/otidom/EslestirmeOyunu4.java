...
public class EslestirmeOyunu4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eslestirme_oyunu4);

        rootLayout = (ViewGroup) findViewById(R.id.view_root4);
        img = (ImageView) rootLayout.findViewById(R.id.imageView4);

        final MediaPlayer elmayiesle = MediaPlayer.create(this, R.raw.karpuzuesle);
        elma = MediaPlayer.create(this,R.raw.karpuz);
        ...
        img.setOnTouchListener(new EslestirmeOyunu4.ChoiceTouchListener());
    }
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (layoutParams.x>250 && layoutParams.x<350 && layoutParams.y>180 && layoutParams.y<260){
                        ...
                        Intent intent2 = new Intent(EslestirmeOyunu4.this,EslestirmeOyunu5.class);
