...
public class EslestirmeOyunuSon extends AppCompatActivity {
    private Button btnCikis;
    String id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eslestirme_oyunu_son);
        ...
        btnCikis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(EslestirmeOyunuSon.this,OyunlarActivity.class);
