...
public class EslestirmeOyunu extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer elmayiesle = MediaPlayer.create(this, R.raw.elmayiesle);
        elma = MediaPlayer.create(this,R.raw.elma);
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (layoutParams.x>500 && layoutParams.x<650 && layoutParams.y>180 && layoutParams.y<260){
                        ...
                        Intent intent2 = new Intent(EslestirmeOyunu.this,EslestirmeOyunu2.class);
